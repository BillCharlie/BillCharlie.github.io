...
const translations = {
  ...
  en: {
    ...
    "meta.description":
      "Personal homepage of Ping Yu-Chen / Bill Chen: GaN power FinFET devices, photomask design, process development, analog IC design, EDA tools, AI research tools, and life notes.",
    ...
    "research.ganHeading": "TCAD Simulation, Design, Process Development, and Measurement for GaN Power FinFET Devices",
    "research.cardQuestionTag": "Core Question",
    "research.cardQuestionTitle": "Key Tradeoffs in GaN Power FinFETs",
    "research.body":
      "My current focus is the tradeoff space of GaN Power FinFETs: threshold voltage, on-resistance, breakdown voltage, and switching loss. The main questions are the Vth-Ron,sp tradeoff, Ron,spQg / Ron,spQgd FOM tradeoffs, BV and Epeak limits, and whether the structure can converge within a realistic process flow.",
    "research.cardSimTitle": "GaN Trigate TCAD 3D Simulation",
    "research.li1":
      "I build 3D GaN Trigate TCAD models and sweep fin geometry, Al composition, tox, Lg, and electric-field profiles to study Vth, Ron, BV, Epeak, and charge-related FOMs.",
    "research.cardProcessTitle": "D-mode / E-mode GaN FinFET Process Design",
    "research.li3":
      "I translate TCAD results into photomask layouts, test structures, and run cards for each process step while breaking down E-beam dose, PEC, development, hardmask transfer, ICP-RIE etch profiles, and process windows.",
    "research.li4": "ICP-RIE pressure, gas chemistry, bias power, and etch-selectivity window design.",
    "research.cardMeasureTitle": "Static and Dynamic Characterization",
    "research.li5":
      "I plan TLM, HBD/VBD, Id-Vg, Id-Vd, Ig-Vg, breakdown, high-frequency C-V, and double-pulse dynamic characterization, then feed the results back into the next device and process iteration.",
    ...
    "analog.anaBody":
      "Led the design of a differential amplifier, hysteresis comparator, and bandgap reference, covering operating-principle analysis, transistor sizing, Cadence pre-layout simulation testbenches, PSRR / CMRR, ff / ss corner simulation, layout, parasitic extraction, and post-layout verification.",
    ...
    "experience.sicBody":
      "Independently carried out SiC VDMOSFET device simulation with TCAD Sentaurus, tuned structural parameters, designed the VDMOS photomask, and organized CV, IV, and double-pulse measurement work.",
