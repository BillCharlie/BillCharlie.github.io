...
const translations = {
  zh: {
    ...
    "projects.patentTitle": "區塊鏈與情緒運算發明專利",
    "projects.patentIntro": "2021–2022 年以發明人 / 共同發明人身分申請的區塊鏈、社交網絡與情緒運算相關專利。",
    "projects.patent1": "具防護功能的自動化設備機架（實用新型）",
  ...
  en: {
    ...
    "projects.patentTitle": "Blockchain & Affective-Computing Patents",
    "projects.patentIntro": "Blockchain, social-network, and affective-computing patents filed in 2021–2022 as inventor or co-inventor.",
    "projects.patent1": "Automation equipment rack with protection function (utility model)",
    ...
    "projects.openPatent": "View all patents",
